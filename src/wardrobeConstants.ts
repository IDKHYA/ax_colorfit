...
export const STORAGE_KEYS = {
  ...
  savedFolders: 'integrated_saved_outfit_folders',
} as const;

export const DEFAULT_SAVED_LOOK_FOLDERS: SavedLookFolder[] = [
  { id: 'folder-daily', name: '데일리', tint: '#FFF2B9', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'folder-office', name: '출근', tint: '#E4E9FF', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'folder-date', name: '데이트', tint: '#FFE0DA', createdAt: '2026-01-01T00:00:00.000Z' },
];
